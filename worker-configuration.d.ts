/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 636bd9e9fe1a2d3ef04b8606fae13026)
// Runtime types generated with workerd@1.20260811.1 2026-08-17 
interface __BaseEnv_Env {
	DB: D1Database;
	CASHBACK_RATE: "0.60";
	MIN_PAYOUT_VND: "50000";
	AT_SHOPEE_CAMPAIGN_ID: "4751584435713464237";
	AT_API_BASE: "https://api.accesstrade.vn";
	TURNSTILE_SITE_KEY: "0x4AAAAAAESsPyHuWNfILVqI";
	TURNSTILE_HOSTNAMES: "hoanlai.id.vn,www.hoanlai.id.vn,hoanlai.hoanlaivn.workers.dev";
	SERVICE_MODE: "closed_beta";
	BUSINESS_LEGAL_NAME: "";
	BUSINESS_ADDRESS: "";
	SUPPORT_EMAIL: "";
	APP_ORIGIN: "https://hoanlai.id.vn";
	EMAIL_FROM: "Hoàn Lại <no-reply@notify.hoanlai.id.vn>";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CASHBACK_RATE" | "MIN_PAYOUT_VND" | "AT_SHOPEE_CAMPAIGN_ID" | "AT_API_BASE" | "TURNSTILE_SITE_KEY" | "TURNSTILE_HOSTNAMES" | "SERVICE_MODE" | "BUSINESS_LEGAL_NAME" | "BUSINESS_ADDRESS" | "SUPPORT_EMAIL" | "APP_ORIGIN" | "EMAIL_FROM">> {}
}
